<?php
  class EventManager {
      public function returnEvents() {
        return Db::multiQuery("SELECT event_id, event_name, games.game_name as game_name, games.game_id as game_id, bracket_status,
      ...
      public function returnEventByUrl($url) {
        return Db::singleQuery("SELECT event_id, event_name, games.game_name as game_name, games.game_id as game_id, bracket_status,
         concat(substr(event_timestamp,9,2), '.', substr(event_timestamp,6,2), '.', substr(event_timestamp,1,4), ' ', substr(event_timestamp,12,5)) as event_parseddate,
